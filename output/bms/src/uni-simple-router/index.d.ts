...
export declare function componentSetup(
  props: Readonly<
    LooseRequired<
      Readonly<
        ExtractPropTypes<{
...
export declare type dynamicImportComponentRule = (
  path: string,
  optios?: {
    pageType?: `top` | ''
...
declare type ExecInstanceTaskRule<T> = Array<[InstanceSpaceRule<T>] | [InstanceSpaceRule<T>, string] | InstanceSpaceRule<T>>
...
export declare type NavigationGuard = (
  ...
  | Promise<void | boolean | RoutePushLocationRaw | RouteLocationRaw | NavigateBackRaw>
  | void
  | boolean
...
export declare type normalizeRouteComponentsRule = Record<
  string,
  {
    componentName: string
...
declare type OptionHookNameRule =
  | `onLaunch`
  | `onInit`
  | `onLoad`
  | `onReady`
...
export declare type platformRule =
  | `h5`
  | `app`
  | `mp-toutiao`
  | `mp-weixin`
...
declare type PositionHookNameRule =
  | `bm`
  | `m`
  | `bu`
  | `u`
...
export declare type RouteRecordRowMap = Record<
  string,
  {
    to: RouteRecordRow
    from: RouteRecordRow
