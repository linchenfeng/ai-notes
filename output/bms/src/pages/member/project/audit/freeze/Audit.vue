 ...
 * @LastEditTime : 2025-11-07 11:21:27
 * @Description  : 冻结/解冻申请审批 /member/project/audit/warning/audit/:refcode/:taskRefcode
-->
...
<template>
  ...
  <view class="main">
    ...
    <view class="special-audit">
      ...
      <view v-if="getHasPermissionsById('member:project:audit:freeze:audit') && vm.freezeInfo.applyStatus === '1'" class="button-fixed-bottom">
...
const onRefuse = () => {
  ...
  getFreezeAppInfo('onRefuse')
}
// 提交
const toSubmit = () => {
  getFreezeAppInfo('doSubmit')
}
