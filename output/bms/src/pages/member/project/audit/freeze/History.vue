 ...
 * @LastEditTime : 2025-08-06 11:05:26
...
import { HistoryItem } from '@/interfaces/member/project/audit/freezeApprovalAudit'
...
const getFreezeAppHistoryInfo = () => {
  const data = {
    refcode: refcode.value
  }
  apiFreezeApprovalAudit.getFreezeAppHistoryInfo(data).then(res => {
