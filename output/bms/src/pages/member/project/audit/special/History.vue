 ...
 * @Description  : 项目-业务审核-特批申请历史审核意见 /member/project/specialAudit/history
-->
...
import { HistoryList } from '@/interfaces/member/project/audit/specialApprovalAudit'
...
const getSpecialAppHistoryInfo = () => {
  const data = {
    refcode: refcode.value
  }
  apiSpecialApprovalQuery.getSpecialAppHistoryInfo(data).then(res => {
