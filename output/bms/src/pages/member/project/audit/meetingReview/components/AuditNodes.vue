 ...
 * @LastEditTime : 2025-10-27 18:25:49
 * @Description  : 审批节点
-->
<template>
  <view class="node-card">
    <view class="node-header">
      ...
      <view class="title-box">
        ...
        <text v-if="props.auditItem.operationScene === '1' || ['9', '91'].includes(props.auditItem.metStatus)" class="status">撤回</text>
...
import { HistoryListItem } from '@/interfaces/member/project/audit/meetingReview'
