 ...
 * @LastEditTime : 2025-12-19 16:00:39
 * @Description  : 项目-业务查询-融资申请查询-详情 /member/project/query/loanApply/detail
-->
<template>
  <NavBar />
  <view>
    <view class="businessApply-internation">
      <apply-info :fint-loa-vo="vm.fintLoaVo" class="apply-info" />
