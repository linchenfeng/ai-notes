  ...
  [
    ...
    function (module, exports, __webpack_require__) {
      ...
      _pdfjsLib.PDFJS.ignoreCurrentPositionOnZoom =
        _pdfjsLib.PDFJS.ignoreCurrentPositionOnZoom === undefined ? false : _pdfjsLib.PDFJS.ignoreCurrentPositionOnZoom
      {
        _pdfjsLib.PDFJS.locale =
          _pdfjsLib.PDFJS.locale === undefined && typeof navigator !== 'undefined' ? navigator.language : _pdfjsLib.PDFJS.locale
      }
      ...
      var PDFViewerApplication = {
        ...
        _initializeViewerComponents: function _initializeViewerComponents() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this2.pdfDocumentProperties = new _pdf_document_properties.PDFDocumentProperties(
        ...
        //强制放大
        forceZoomIn: function forceZoomIn() {
        ...
        //强制缩小
        forceZoomOut: function forceZoomOut() {
          let newScale = this.pdfViewer.currentScale
          newScale = (newScale / DEFAULT_SCALE_DELTA).toFixed(2)
          newScale = Math.floor(newScale * 10) / 10
          newScale = Math.max(_ui_utils.MIN_SCALE, newScale)
              ...
              .then(function (_ref2) {
                ...
                if (values.exists && _this6.viewerPrefs['showPreviousViewOnLoad']) {
                  hash =
                    ...
                    values.page +
                    '&zoom=' +
                    (_this6.viewerPrefs['defaultZoomValue'] || values.zoom) +
                    ',' +
                    values.scrollLeft +
                    ',' +
                    values.scrollTop
        ...
        setInitialView: function setInitialView(storedHash) {
          ...
          this.pdfViewer.currentPageNumber = 1 //初始化默认显示第一页码
          this.toolbar.setPageNumber(this.pdfViewer.currentPageNumber, this.pdfViewer.currentPageLabel)
          this.secondaryToolbar.setPageNumber(this.pdfViewer.currentPageNumber)
          // 【ARM-6191】
          // 初始化默认关闭目录，避免部分PDF自动弹出
            ...
            value: function draw() {
              ...
              if (this.textLayerFactory) {
                ...
                var defaultSettings = {
                  ...
                  // watermark_img: "",
                  watermark_txt: `致：${sessionStorage.pdfLoginId}\n内部文件，请勿外传！\n${formateTime()}`,
                  ...
                  watermark_fontsize: '11px', //水印字体大小
                ...
                for (var i = 0; i < defaultSettings.watermark_rows; i++) {
                  ...
                  for (var j = 0; j < defaultSettings.watermark_cols; j++) {
                    ...
                    mask_div.style.whiteSpace = 'pre-line'
                    if (i % 2 != 0) {
                      mask_div.style.left = x + 0 + 'px'
                    } else {
