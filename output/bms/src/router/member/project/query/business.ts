...
export default [
  {
    path: '/member/project/query/business',
    name: 'business',
    meta: {
      title: '业务洞察',
      ...
      funids: 'member:project:query:business' // 权限id
    },
    component: __dynamicImportComponent__('@/pages/member/project/query/business/index.vue', {
      pageType: `top`,
      style: {
