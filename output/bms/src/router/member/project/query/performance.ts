 ...
 * @Description  : 项目-数据洞察-业绩过程
 */
import { __dynamicImportComponent__ } from '@/uni-simple-router'
export default [
  {
    path: '/member/project/query/business/performance',
    ...
    meta: {
      ...
      funids: 'member:project:query:business:performance' // 权限id
    },
    component: __dynamicImportComponent__('@/pages/member/project/query/business/performance/index.vue', {
      pageType: `top`,
      style: {
